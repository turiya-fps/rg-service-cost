...
import { PostProjectCostingCalculationResourceApiHandlerDefinition } from './post-project-costing-calculation-resource';

const DIR_ROOT = path.resolve(__dirname, '..', '..', '..', '..', '..');

describe(PostProjectCostingCalculationResourceApiHandlerDefinition.name, (): void => {
  it('with handler function, entrypoint file exists in project', async (): Promise<void> => {
    ...
    const definition = new PostProjectCostingCalculationResourceApiHandlerDefinition(stack, {
      providers: {
