...
import type { HandlerEnvironmentMapping } from '@project-rouge/service-cost/src/handler/api/project/post-project-costing-calculation-resource/entrypoint';
import { route } from '@project-rouge/service-cost/src/handler/api/project/post-project-costing-calculation-resource/entrypoint';
...
export class PostProjectCostingCalculationResourceApiHandlerDefinition extends Construct {
  ...
  public constructor(scope: Construct, props: HandlerDefinitionProps) {
    ...
    const operation = 'post-project-costing-calculation-resource';
