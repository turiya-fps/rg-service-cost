...
import { GetProjectCostingResourceApiHandlerDefinition } from './get-project-costing-resource';

const DIR_ROOT = path.resolve(__dirname, '..', '..', '..', '..', '..');

describe(GetProjectCostingResourceApiHandlerDefinition.name, (): void => {
  it('with handler function, entrypoint file exists in project', async (): Promise<void> => {
    ...
    const definition = new GetProjectCostingResourceApiHandlerDefinition(stack, {
      providers: {
