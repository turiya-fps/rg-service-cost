...
import type { HandlerEnvironmentMapping } from '@project-rouge/service-cost/src/handler/api/project/patch-project-costing-resource/entrypoint';
import { route } from '@project-rouge/service-cost/src/handler/api/project/patch-project-costing-resource/entrypoint';
...
export class PatchProjectCostingResourceApiHandlerDefinition extends Construct {
  ...
  public constructor(scope: Construct, props: HandlerDefinitionProps) {
    ...
    const operation = 'patch-project-costing-resource';
