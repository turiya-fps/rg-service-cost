...
import type { HandlerEnvironmentMapping } from '@project-rouge/service-cost/src/handler/api/project/get-project-costing-resource/entrypoint';
import { route } from '@project-rouge/service-cost/src/handler/api/project/get-project-costing-resource/entrypoint';
...
export class GetProjectCostingResourceApiHandlerDefinition extends Construct {
  ...
  public constructor(scope: Construct, props: HandlerDefinitionProps) {
    ...
    const operation = 'get-project-costing-resource';
