...
import { PatchProjectCostingResourceApiHandlerDefinition } from './patch-project-costing-resource';

const DIR_ROOT = path.resolve(__dirname, '..', '..', '..', '..', '..');

describe(PatchProjectCostingResourceApiHandlerDefinition.name, (): void => {
  it('with handler function, entrypoint file exists in project', async (): Promise<void> => {
    ...
    const definition = new PatchProjectCostingResourceApiHandlerDefinition(stack, {
      providers: {
